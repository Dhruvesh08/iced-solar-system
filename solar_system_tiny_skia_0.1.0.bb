...
# how to get solar_system_tiny_skia could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/solar_system_tiny_skia/0.1.0"
SRC_URI += "git://github.com/Dhruvesh08/iced-solar-system.git;protocol=https;nobranch=1;branch=solar-system-tiny-skia"
SRCREV = "560f09331e960814f30ce738893be7f819d3eb3c"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+560f09331e"
...
SRC_URI += " \
    ...
    crate://crates.io/lyon_tessellation/1.0.10 \
...
SUMMARY = "solar_system_tiny_skia"
...
include solar_system_tiny_skia-${PV}.inc
include solar_system_tiny_skia.inc
